...
for size in 19 23 27 31 35; do
	...
	for file in *.svg; do
		sed -i '/#008000/s/fill-opacity:1/fill-opacity:0.5/' $file
	        sed -i '/#009000/s/fill-opacity:1/fill-opacity:0.5/' $file
	        sed -i '/#800000/s/fill-opacity:1/fill-opacity:0.5/' $file
	        sed -i '/#900000/s/fill-opacity:1/fill-opacity:0.5/' $file
