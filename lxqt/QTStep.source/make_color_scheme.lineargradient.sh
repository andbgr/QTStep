...
colors[active-gradient-1]=$(shadesimple ${colors[active]} 1.167)
colors[active-gradient-2]=$(shadesimple ${colors[active]} 1.119)
colors[active-gradient-3]=$(shadesimple ${colors[active]} 1.071)
colors[active-gradient-4]=$(shadesimple ${colors[active]} 1.024)
colors[active-gradient-5]=$(shadesimple ${colors[active]} 0.976)
colors[active-gradient-6]=$(shadesimple ${colors[active]} 0.929)
colors[active-gradient-7]=$(shadesimple ${colors[active]} 0.881)
colors[active-gradient-8]=$(shadesimple ${colors[active]} 0.833)
